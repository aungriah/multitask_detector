...
def cal_dir_stat(root):
    ...
    for idx, d in enumerate(listdir(root)):
        print("#{} class".format(idx))
        im_pths = glob(join(root, d))
        print(im_pths)
        for path in im_pths:
...
# of training images.
train_root = "/Users/aungriah/Desktop/Finetuning/finetuning/training/image"
# train_root = "/Users/aungriah/Documents/MT/Data/kitti/training/image_2"
