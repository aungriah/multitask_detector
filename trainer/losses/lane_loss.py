...
def get_loss_dict(use_aux, sim_loss_w, shp_loss_w):
    """
    use_aux: bool, whether auxiliary segmentation branch is activated or not
    sim_loss_w: weight of lane similarity loss
    shp_loss_w: weight of lane shape loss
    returns a dictionary containing losses and their corresponding weights
    """
    if use_aux:
        loss_dict = {
